export const PasswordsVariants = {
  sizes: {
    small:
      "p-2 w-52 hover:brightness-105 transition ease-in-out duration-300",
    medium:
      "p-2 w-64 hover:brightness-105 transition ease-in-out duration-300",
    large:
      "p-2 w-96 hover:brightness-105 transition ease-in-out duration-300",
      fullWidth:
  ...
  errorMessageStyle: "text-xs font-thin text-sm"
};
